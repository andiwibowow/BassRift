 ...
 * This file demonstrates how to integrate Bassrift with a web frontend
 */

// For React/Vue/Angular applications
export class BassriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BassriftClient(provider, contractAddress);
